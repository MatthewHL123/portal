  ...
  return (
    <div className="p-2 ml-2" style={{ width: "410px", marginTop: "18px" }}>
      <div className="border border-gray-400 bg-white">
        <div className="flex items-center space-x-2 mb-2 pl-3 pt-3" style={{ width: "297px" }}>
        ...
        <div className="flex-1 items-center space-x-2 mb-2 pl-3 pt-3" style={{ width: "297px" }}>
